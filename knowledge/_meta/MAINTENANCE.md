...
- **Do the three `.claude/settings.json` deny files still exist** (Hub root, `Agroecology_Evidence_Hub/`,
  `ERA/Script/`) and still list the protected paths? They are what makes rule 2 enforced rather than merely
  written. → `../09_conventions.md` §13
